...
class Wire : public mcpat::Component
{
  public:
    ...
    static mcpat::Component global;
    static mcpat::Component global_5;
    static mcpat::Component global_10;
    static mcpat::Component global_20;
    static mcpat::Component global_30;
    static mcpat::Component low_swing;
  ...
  private:
    ...
    list <mcpat::Component> repeated_wire;
    void update_fullswing();
    static int initialized;


    //low-swing
    mcpat::Component transmitter;
    mcpat::Component l_wire;
    mcpat::Component sense_amp;
