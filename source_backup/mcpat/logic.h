...
class selection_logic : public mcpat::Component{
public:
	...
	const ParseXML *XML_interface;
        /* num_arbiter is necessary for fast leakage feedback. Note that num_arbiter declaration is deleted
           in selection_power() function.
...
class dep_resource_conflict_check : public mcpat::Component{
public:
...
class inst_decoder: public mcpat::Component{
public:
...
class DFFCell : public mcpat::Component {
public:
...
class Pipeline : public mcpat::Component{
public:
...
class FunctionalUnit :public mcpat::Component{
public:
	ParseXML *XML;
	int  ithCore;
	...
	double num_fu;
	double energy, base_energy,per_access_energy;
	bool  is_default;
...
class UndiffCore :public mcpat::Component{
public:
