package gatech.edu.iris.viewer;
...
public class Viewer extends JPanel {
    ...
    public Viewer(Graph g, String label) {
...
//        opanel.add(overview);
    ...
    public static void main(String[] args) {
        ...
        // create graphview
      //this will be overridden if anything is specified on the command line.
        String datafile = "/output.graphml"; 
    ...
    public static JFrame demo(Graph g, String label) {
        final Viewer view = new Viewer(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        private Viewer m_view;
        public GraphMenuAction(String name, String accel, Viewer view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(Viewer view) {
            m_view = view;
