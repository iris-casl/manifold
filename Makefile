...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = manifold_simIris$(EXEEXT) manifold_simMC$(EXEEXT)
subdir = .
...
am__objects_2 = manifold_simMC-mesh.$(OBJEXT) \
	manifold_simMC-torus.$(OBJEXT) manifold_simMC-visual.$(OBJEXT)
am_manifold_simMC_OBJECTS = $(am__objects_2) \
...
CXXLINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) $(AM_LDFLAGS) $(LDFLAGS) \
	-o $@
SOURCES = $(manifold_simIris_SOURCES) $(manifold_simMC_SOURCES)
DIST_SOURCES = $(manifold_simIris_SOURCES) $(manifold_simMC_SOURCES)
...
ACLOCAL = ${SHELL} /home/sharda/new/manifold/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/sharda/new/manifold/missing --run tar
AUTOCONF = ${SHELL} /home/sharda/new/manifold/missing --run autoconf
AUTOHEADER = ${SHELL} /home/sharda/new/manifold/missing --run autoheader
AUTOMAKE = ${SHELL} /home/sharda/new/manifold/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/sharda/new/manifold/missing --run makeinfo
OBJEXT = o
PACKAGE = Iris
...
infodir = ${prefix}/info
install_sh = /home/sharda/new/manifold/install-sh
...
SUBDIRS = source/memctrl source/simIris .
ALL_HDRS = \
	   ...
	   source/simIris/components/impl/mcFrontEnd.h \
...
manifold_simIris$(EXEEXT): $(manifold_simIris_OBJECTS) $(manifold_simIris_DEPENDENCIES) 
	...
	$(CXXLINK) $(manifold_simIris_LDFLAGS) $(manifold_simIris_OBJECTS) $(manifold_simIris_LDADD) $(LIBS)
manifold_simMC$(EXEEXT): $(manifold_simMC_OBJECTS) $(manifold_simMC_DEPENDENCIES) 
	@rm -f manifold_simMC$(EXEEXT)
	$(CXXLINK) $(manifold_simMC_LDFLAGS) $(manifold_simMC_OBJECTS) $(manifold_simMC_LDADD) $(LIBS)
...
manifold_simIris-mesh.o: source/frontend/impl/mesh.cc
	if $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(manifold_simIris_CXXFLAGS) $(CXXFLAGS) -MT manifold_simIris-mesh.o -MD -MP -MF "$(DEPDIR)/manifold_simIris-mesh.Tpo" -c -o manifold_simIris-mesh.o `test -f 'source/frontend/impl/mesh.cc' || echo '$(srcdir)/'`source/frontend/impl/mesh.cc; \
	then mv -f "$(DEPDIR)/manifold_simIris-mesh.Tpo" "$(DEPDIR)/manifold_simIris-mesh.Po"; else rm -f "$(DEPDIR)/manifold_simIris-mesh.Tpo"; exit 1; fi
...
manifold_simIris-torus.o: source/frontend/impl/torus.cc
	if $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(manifold_simIris_CXXFLAGS) $(CXXFLAGS) -MT manifold_simIris-torus.o -MD -MP -MF "$(DEPDIR)/manifold_simIris-torus.Tpo" -c -o manifold_simIris-torus.o `test -f 'source/frontend/impl/torus.cc' || echo '$(srcdir)/'`source/frontend/impl/torus.cc; \
	then mv -f "$(DEPDIR)/manifold_simIris-torus.Tpo" "$(DEPDIR)/manifold_simIris-torus.Po"; else rm -f "$(DEPDIR)/manifold_simIris-torus.Tpo"; exit 1; fi
...
manifold_simIris-visual.o: source/frontend/impl/visual.cc
	if $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(manifold_simIris_CXXFLAGS) $(CXXFLAGS) -MT manifold_simIris-visual.o -MD -MP -MF "$(DEPDIR)/manifold_simIris-visual.Tpo" -c -o manifold_simIris-visual.o `test -f 'source/frontend/impl/visual.cc' || echo '$(srcdir)/'`source/frontend/impl/visual.cc; \
	then mv -f "$(DEPDIR)/manifold_simIris-visual.Tpo" "$(DEPDIR)/manifold_simIris-visual.Po"; else rm -f "$(DEPDIR)/manifold_simIris-visual.Tpo"; exit 1; fi
...
manifold_simIris-manifold_simiris.o: source/frontend/impl/manifold_simiris.cc
	...
	then mv -f "$(DEPDIR)/manifold_simIris-manifold_simiris.Tpo" "$(DEPDIR)/manifold_simIris-manifold_simiris.Po"; else rm -f "$(DEPDIR)/manifold_simIris-manifold_simiris.Tpo"; exit 1; fi
...
manifold_simMC-mesh.o: source/frontend/impl/mesh.cc
	if $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(manifold_simMC_CXXFLAGS) $(CXXFLAGS) -MT manifold_simMC-mesh.o -MD -MP -MF "$(DEPDIR)/manifold_simMC-mesh.Tpo" -c -o manifold_simMC-mesh.o `test -f 'source/frontend/impl/mesh.cc' || echo '$(srcdir)/'`source/frontend/impl/mesh.cc; \
	then mv -f "$(DEPDIR)/manifold_simMC-mesh.Tpo" "$(DEPDIR)/manifold_simMC-mesh.Po"; else rm -f "$(DEPDIR)/manifold_simMC-mesh.Tpo"; exit 1; fi
...
manifold_simMC-torus.o: source/frontend/impl/torus.cc
	if $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(manifold_simMC_CXXFLAGS) $(CXXFLAGS) -MT manifold_simMC-torus.o -MD -MP -MF "$(DEPDIR)/manifold_simMC-torus.Tpo" -c -o manifold_simMC-torus.o `test -f 'source/frontend/impl/torus.cc' || echo '$(srcdir)/'`source/frontend/impl/torus.cc; \
	then mv -f "$(DEPDIR)/manifold_simMC-torus.Tpo" "$(DEPDIR)/manifold_simMC-torus.Po"; else rm -f "$(DEPDIR)/manifold_simMC-torus.Tpo"; exit 1; fi
...
manifold_simMC-visual.o: source/frontend/impl/visual.cc
	if $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(manifold_simMC_CXXFLAGS) $(CXXFLAGS) -MT manifold_simMC-visual.o -MD -MP -MF "$(DEPDIR)/manifold_simMC-visual.Tpo" -c -o manifold_simMC-visual.o `test -f 'source/frontend/impl/visual.cc' || echo '$(srcdir)/'`source/frontend/impl/visual.cc; \
	then mv -f "$(DEPDIR)/manifold_simMC-visual.Tpo" "$(DEPDIR)/manifold_simMC-visual.Po"; else rm -f "$(DEPDIR)/manifold_simMC-visual.Tpo"; exit 1; fi
...
manifold_simMC-manifold_simmc.o: source/frontend/impl/manifold_simmc.cc
	...
	then mv -f "$(DEPDIR)/manifold_simMC-manifold_simmc.Tpo" "$(DEPDIR)/manifold_simMC-manifold_simmc.Po"; else rm -f "$(DEPDIR)/manifold_simMC-manifold_simmc.Tpo"; exit 1; fi
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/source/frontend/impl $(distdir)/source/kernel $(distdir)/source/memctrl $(distdir)/source/simIris/components/impl $(distdir)/source/simIris/components/interfaces $(distdir)/source/simIris/data_types/impl $(distdir)/source/util
