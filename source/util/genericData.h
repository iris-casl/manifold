...
enum ROUTING_SCHEME { XY, NEGATIVE_FIRST, ODD_EVEN, WEST_FIRST, NORTH_LAST, NORTH_LAST_NON_MINIMAL };
enum SW_ARBITRATION { ROUND_ROBIN, FCFS, ROUND_ROBIN_PRIORITY };
enum RouterPipeStage { INVALID, 
    EMPTY,
    IB, 
    FULL, 
    ROUTED,
...
enum  ROUTER_MODEL { PHYSICAL_3STAGE, VIRTUAL_4STAGE};
enum  MC_MODEL { GENERIC_MC, FLAT_MC};
