...
class MCBackend : public mcpat::Component {
  public:
    InputParameter l_ip;
...
class MCPHY : public mcpat::Component {
  public:
    InputParameter l_ip;
    uca_org_t local_result;
    MCParam  mcp;
...
class MCFrontEnd : public mcpat::Component {
  public:
	ParseXML *XML;
...
class MemoryController : public mcpat::Component {
  public:
	ParseXML *XML;
	InputParameter interface_ip;
    MCParam  mcp;
