    ...
    resistivity(resistivity), deviceType(dt)
{
  ...
  assert(power.readOp.gate_leakage > 0);
    ...
    mcpat::Component Wire::global;
    mcpat::Component Wire::global_5;
    mcpat::Component Wire::global_10;
    mcpat::Component Wire::global_20;
    mcpat::Component Wire::global_30;
    mcpat::Component Wire::low_swing;
...
Wire::init_wire(){
  ...
  double i, j, del;
  repeated_wire.push_back(mcpat::Component());
...
void Wire::update_fullswing()
{
  ...
  list<mcpat::Component>::iterator citer;
  double del[4];
