...
class Decoder : public mcpat::Component
{
  public:
    Decoder(
...
class PredecBlk : public mcpat::Component
{
 public:
  PredecBlk(
      int num_dec_signals,
...
class PredecBlkDrv : public mcpat::Component
{
 public:
  PredecBlkDrv(
      int   way_select,
...
class Predec : public mcpat::Component
{
  public:
    Predec(
        PredecBlkDrv * drv1,
...
class Driver : public mcpat::Component
{
 public:
