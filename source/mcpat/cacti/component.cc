...
double mcpat::Component::compute_diffusion_width(int num_stacked_in, int num_folded_tr)
{
...
double mcpat::Component::compute_gate_area(
    int gate_type,
    int num_inputs,
    double w_pmos,
    double w_nmos,
...
double mcpat::Component::compute_tr_width_after_folding(
    double input_width,
...
double mcpat::Component::height_sense_amplifier(double pitch_sense_amp)
{
...
int mcpat::Component::logical_effort(
    int num_gates_min,
    double g,
    double F,
    double * w_n,
